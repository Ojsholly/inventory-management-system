...
if ($_POST['category'] == ''){
...

    {
        ...
        $data = array("name"=>$product_name,"category_id"=>$category,"price"=>$price,"image"=>$filename,"info"=>$info,"stock_count"=>$stock_count);
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                      ...
                      foreach($category as $item) {
                        ...
                        ?>
                        <option value="<?php echo $item['id']; ?>"><?php echo $item['category_name']; ?></option><?php     // echo '<pre>'; var_dump($category);
                      }
