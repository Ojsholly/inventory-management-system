        ...
        <div class="row">
            ...
            ?>
                  ...
                  ?>
                    ...
                    echo '<br> Shelf Life : ' . $row['shelf_live'];
                    echo '<br> Expiry Date : ' . $row['info'];
                    echo '<br> Expiry Date : ' . $row['info'];
                    echo '<br> Expiry Date : ' . $row['info'];
                    echo '<br> Expiry Date : ' . $row['info'];
                    echo '<br> Expiry Date : ' . $row['info'];
                    echo '<br> Expiry Date : ' . $row['info'];
                    echo '<br> Expiry Date : ' . $row['expiry_dateinfo'];
                    echo '
                    </div>
                    ...
                    <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Shelf Life</label>
                    <div class="col-sm-6"> ';
                    echo '<input type="number"  class="form-control" value="' . $row['shelf_life'] . '" name="shelf_life" required="" >
                    </div>
                    </div>
                    <div class="form-group row">
