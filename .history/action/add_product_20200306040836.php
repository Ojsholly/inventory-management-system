        ...
        <div class="row">
            ...
            if (isset($_POST['submit'])) {
              ...
              if ($_POST['category'] == '') {
                ...
                $update_time = date('YHhhhhhhhhhhhhhhh-m-d');
            ...
            ?>
                    ...
                    ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" placeholder="Enter product price." class="form-control"
                                        required="" value="<?php echo $price ?>" name="price" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Amount Of Product In Stock</label>
                                <div class="col-sm-6">
                                    <input type="number" placeholder="Enter amount of product in stock."
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <textarea class="form-control" rows="7" placeholder="Enter product info."
                                        value="<?php echo $info ?>" name="info"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
