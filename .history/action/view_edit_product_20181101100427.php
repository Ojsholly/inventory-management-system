...
//                      $result = mysqli_query($dbc, $sql);
                      ...
                      $data = array("name" => $product, "price" => $price, "info" => $info, "stock_count" => $stock_count);
                ...
                <tbody>
                  ...
                  while ($row = mysqli_fetch_array($product)):
                    ...
                    <tr>
                      ...
                      <td><img src="products/<?php echo $row['image'] == '' ? 'product.jpg' : $row['image'] ?>"></td>
                      <td><?php echo ucfirst($row['name'])?></td>
                      <td><?php echo number_format($row['price'], 2)?></td>
                      <td><?php echo $category[0]['category_name'] = 0 ? 'Not Categorized' : $category[0]['category_name']?></td>
